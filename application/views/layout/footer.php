        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2018-II <a href="https://adminlte.io">Sislsm</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
...
<script type="text/javascript">
    ...
    function cargar(){
      $("#mantenimientos").empty().html("<center> <br><br><br><img src=' "+url+"librerias/img/cargando.gif' style='width:200px;'></center>");
    }
</script>
